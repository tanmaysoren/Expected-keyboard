...
public class ExtraKeysPreference extends PreferenceCategory
{
  ...
  {
    return mk_preferred_pos_dir(next_to_key, row, col, prefer_bottom_right ? 4 : 3, prefer_bottom_right ? 3 : 4);
  }

  static KeyboardData.PreferredPos mk_preferred_pos_dir(String next_to_key, int row, int col, int d1, int d2)
  {
  ...
  static KeyboardData.PreferredPos key_preferred_pos(String key_name)
  {
    switch (key_name)
    {
      ...
      case "€": return mk_preferred_pos("e", 0, 2, true);
      case "ß": return mk_preferred_pos("s", 1, 1, false);
      case "§": return mk_preferred_pos_dir("s", 1, 1, 2, 1);
      case "£": return mk_preferred_pos("l", 1, 8, true);
      case "†": return mk_preferred_pos_dir("z", 2, 0, 2, 1);
      case "tab": return mk_preferred_pos_dir("a", 1, 0, 1, 2);
      case "esc": return mk_preferred_pos("q", 0, 0, true);
      case "alt": return mk_preferred_pos("d", 1, 2, true);
      case "switch_clipboard": return mk_preferred_pos("f", 1, 3, true);
      case "switch_greekmath": return mk_preferred_pos("g", 1, 4, true);
      case "change_method": return mk_preferred_pos("b", 2, 4, true);
      case "subscript": return mk_preferred_pos("n", 2, 5, true);
      case "superscript": return mk_preferred_pos("n", 2, 5, false);
    }
