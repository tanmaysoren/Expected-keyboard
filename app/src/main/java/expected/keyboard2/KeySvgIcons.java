...
public class KeySvgIcons {
  ...
  static {
    ...
    // 3b. PASTE AS PLAIN TEXT KEY (User Provided Stroke SVG - viewBox 32)
    String pastePlainTextPath = "M23 12 L23 18 L29 18 L23 12 L15 12 L15 30 L29 30 L29 18 M20 6h-8V4c0-1.1 0.9-2 2-2h4c1.1 0 2 0.9 2 2V6z M15 28h-5c-2.2 0-4-1.8-4-4V8c0-2.2 1.8-4 4-4h2 M20 4h2c2.2 0 4 1.8 4 4v7";
    addStrokeIcon('\uE035', pastePlainTextPath, 32f, 2f);
    addStrokeStringIcon("pasteasplaintext", pastePlainTextPath, 32f, 2f);
    addStrokeStringIcon("paste_as_plain_text", pastePlainTextPath, 32f, 2f);
    addStrokeStringIcon("pasteplain", pastePlainTextPath, 32f, 2f);
    addStrokeStringIcon("paste_plain", pastePlainTextPath, 32f, 2f);
