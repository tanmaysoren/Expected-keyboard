...
import expected.keyboard2.DeviceLocales;
import expected.keyboard2.Logs;
import expected.keyboard2.R;
import expected.keyboard2.Utils;
...
public class DictionaryListView extends LinearLayout
{
  ...
  public static URL url_of_dictionary(String dict_name)
      throws MalformedURLException
  {
    return new URL(DICT_REPO_URL + "/v2/" + dict_name + ".dict");
  }
  ...
  boolean install_dictionary_from_internet(String dict_name)
  {
    ...
    {
      Logs.exn("Failed to install dictionary: " + dict_name, e);
      return false;
    }
  }
