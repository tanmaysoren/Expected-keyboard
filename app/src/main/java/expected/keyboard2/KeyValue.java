...
public final class KeyValue implements Comparable<KeyValue>
{
  public static enum Event
  {
    ...
    SWITCH_BACK_EDITING,
    SWITCH_LAYOUT_PANE,
    SWITCH_BACK_LAYOUT_PANE,
    SWITCH_THEME_PANE,
    SWITCH_BACK_THEME_PANE,
  }
  ...
  {
    return resolveSymbols(String.valueOf((char)symbol));
  }

  public static String resolveSymbols(String s)
  {
    ...
    for (int i = 0; i < s.length(); i++)
    {
      ...
      {
        case 0xE000:
        case 0xE00A: sb.append("⇧"); break; // Shift
        case 0xE012: sb.append("⇪"); break; // Caps Lock
        case 0xE00E: sb.append("↵"); break; // Enter
        case 0xE011:
        case 0xE01B: sb.append("⌫"); break; // Backspace / Delete Word
        case 0xE010:
        case 0xE01C: sb.append("⌦"); break; // Forward Delete
        case 0xE00D: sb.append("␣"); break; // Space
        case 0xE00F: sb.append("↹"); break; // Tab
        case 0xE005: sb.append("↑"); break; // Up
        case 0xE006: sb.append("→"); break; // Right
        case 0xE007: sb.append("↓"); break; // Down
        case 0xE008: sb.append("←"); break; // Left
        case 0xE002: sb.append("⇞"); break; // Page Up
        case 0xE003: sb.append("⇟"); break; // Page Down
        case 0xE00B: sb.append("⇱"); break; // Home
        case 0xE00C: sb.append("⇲"); break; // End
        case 0xE01E: sb.append("⎋"); break; // Esc
        case 0xE001: sb.append("☺"); break; // Emoji
        case 0xE004: sb.append("⚙"); break; // Config / Settings
        case 0xE009: sb.append("\uE009"); break; // Change Method / Lang
        case 0xE013: sb.append("\uE013"); break; // Switch forward
        case 0xE014: sb.append("\uE014"); break; // Switch backward
        case 0xE016: sb.append("⎄"); break; // Compose
        case 0xE017: sb.append("\uE017"); break; // Clipboard
        case 0xE018: sb.append("|"); break; // ZWNJ
        case 0xE019: sb.append("+"); break; // ZWJ
        case 0xE01A: sb.append("✕"); break; // Compose cancel
        ...
        case 0xE051: sb.append("ˇ"); break;
        case 0xE052: sb.append("¸"); break;
        case 0xE053: sb.append("ˆ"); break;
        case 0xE054: sb.append("`"); break;
        case 0xE055: sb.append("¯"); break;
        case 0xE056: sb.append("˚"); break;
        case 0xE057: sb.append("˜"); break;
        case 0xE058: sb.append("¨"); break;
        case 0xE059: sb.append("˛"); break;
        case 0xE05A: sb.append("˙"); break;
        case 0xE05B: sb.append("˝"); break;
        case 0xE05C: sb.append("/"); break;
        case 0xE05D: sb.append("→"); break;
        case 0xE05E: sb.append("˘"); break;
        case 0xE05F: sb.append("|"); break;
        case 0xE060: sb.append("."); break;
        case 0xE061: sb.append("̛"); break;
        case 0xE062: sb.append("̉"); break;
        case 0xE063: sb.append("̏"); break;
        default:
          sb.append(c);
          break;
      }
  ...
  public boolean isSpecialFont()
  {
    ...
    if (s != null && s.length() > 0)
    {
      ...
      {
        char c = s.charAt(i);
        if ((c >= 0xE000 && c <= 0xF8FF) || c == '⛶' || (c >= 0x2190 && c <= 0x21FF) || (c >= 0x25A0 && c <= 0x25FF))
          return true;
      }
    }
    return false;
  ...
  {
    return resolveSymbols(_payload.toString());
  }
  ...
  {
    return charKey(symbolToString(symbol), c, flags | FLAG_KEY_FONT);
  }
  ...
  {
    return modifierKey(symbolToString(symbol), m, flags | FLAG_KEY_FONT);
  }

  private static KeyValue diacritic(int symbol, Modifier m)
  {
    return diacritic(symbolToString(symbol), m);
  }
  ...
  {
    return eventKey(symbolToString(symbol), e, flags | FLAG_KEY_FONT);
  }
  ...
  {
    return keyeventKey(symbolToString(symbol), code, flags | FLAG_KEY_FONT);
  }
  ...
  {
    return editingKey(symbolToString(symbol), action, flags | FLAG_KEY_FONT);
  }
  ...
  public static KeyValue getSpecialKeyByName(String name)
  {
    switch (name)
    {
      ...
      case "superscript": case "sup": return modifierKey("sup", Modifier.SUPERSCRIPT, 0);
      case "subscript": case "sub": return modifierKey("sub", Modifier.SUBSCRIPT, 0);
      ...
      case "voice_typing": return null;
      case "voice_typing_chooser": return null;
      ...
      case "complete_fourth": return statefulKey(Stateful.Complete_fourth);
      case "complete_fifth": return statefulKey(Stateful.Complete_fifth);
      ...
      case "toggle_floating": return TOGGLE_FLOATING;
      case "switch_editing": return eventKey("EDIT", Event.SWITCH_EDITING, 0);
      case "switch_back_editing": return eventKey("ABC", Event.SWITCH_BACK_EDITING, 0);
      case "switch_voice": return null;
      case "switch_back_voice": return null;
      case "switch_layout": return eventKey(0xE013, Event.SWITCH_LAYOUT_PANE, 0);
      case "switch_back_layout": return eventKey("ABC", Event.SWITCH_BACK_LAYOUT_PANE, 0);
      case "switch_theme": return eventKey(0xE004, Event.SWITCH_THEME_PANE, 0);
      case "switch_back_theme": return eventKey("ABC", Event.SWITCH_BACK_THEME_PANE, 0);
      ...
      case "prt_scn":
      case "sysrq":
        return keyeventKey("PrtSc", KeyEvent.KEYCODE_SYSRQ, FLAG_SMALLER_FONT);
      case "pause":
      case "break":
        return keyeventKey("Pause", KeyEvent.KEYCODE_BREAK, FLAG_SMALLER_FONT);
      ...
      case "word_left":
      case "cursor_left": return editingKey(0xE008, Editing.WORD_LEFT, 0);
      case "word_right":
      case "cursor_right": return editingKey(0xE006, Editing.WORD_RIGHT, 0);
      case "cursor_up": return editingKey(0xE005, Editing.WORD_LEFT, 0);
      case "cursor_down": return editingKey(0xE007, Editing.WORD_RIGHT, 0);
      ...
      case "selection_word_left": return editingKey(0xE008, Editing.SELECTION_CURSOR_LEFT, 0);
      case "selection_cursor_right":
      case "selection_word_right": return editingKey(0xE006, Editing.SELECTION_CURSOR_RIGHT, 0);
