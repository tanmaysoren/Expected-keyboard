...
public final class LayoutModifier
{
  ...
  public static KeyboardData modify_layout(KeyboardData kw)
  {
    ...
    {
      added_number_row = modify_number_row(globalConfig.number_row_symbols ? number_row_symbols.copy() : number_row_no_symbols.copy(), kw);
    ...
    if (kw.bottom_row)
      kw = kw.insert_row(bottom_row.copy(), kw.rows.size());
